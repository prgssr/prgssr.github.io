...
Аннотации `hreflang` могут передаваться в заголовках HTTP, [в картах сайта](hreflang) или с помощью тегов `link` в `head` ваших страниц. Синтаксис для последнего варианта следующий:
