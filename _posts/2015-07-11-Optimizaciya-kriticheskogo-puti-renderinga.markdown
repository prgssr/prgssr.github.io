...
prism: yes
thumbnail: "/images/development/performance/QJqXxft.png"
---
...
![DOM model](/images/development/performance/kqW6her.png)
...
![CSSOM](/images/development/performance/QJqXxft.png){: itemprop="image"}
...
![DOM и CSSOM](/images/development/performance/EQ16Xr6.png)
...
![критический путь рендеринга](/images/development/performance/igWnro5.png)
...
![Chrome DevTools](/images/development/performance/K1jckWa.png)
...
![критический путь после оптимизации](/images/development/performance/u8ST05U.png)
...
Также можно уменьшить размер CSS с помощью медиа-запросов. Например, для нашего сайта есть стандартные стили, стили для портретной ориентации и стили для печати. Имеет смысл разбить код на несколько файлов и подключать их в случае необходимости:
...
Также в отдельных ситуациях можно инлайнировать блокирующий CSS --- это позволяет сэкономить запросы и ограничить браузер парсингом HTML.
