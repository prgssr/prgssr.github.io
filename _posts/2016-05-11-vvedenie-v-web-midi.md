...
На данный момент  [Web MIDI API поддерживается только в Chrome и Opera](http://caniuse.com/#search=web%20midi), но вы можете наблюдать за [продвижением работы по добавлению его в Firefox в соответствующем треде на сайте](https://bugzilla.mozilla.org/show_bug.cgi?id=836897).
