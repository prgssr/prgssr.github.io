...
*Иллюстрация 1. Эти элементы приложения используются для вывода данных на основе принципов атомарного дизайна. Можете ли вы угадать, в каких из них используется Флексбокс? ([увеличенная версия](https://www.smashingmagazine.com/wp-content/uploads/2015/11/01-atomic-parts-opt.png))*
...
*Иллюстрация 2. Основной интерфейс приложения Tracks, использующий преимущества флексбокса и атомарного дизайна. ([увеличенная версия](https://www.smashingmagazine.com/wp-content/uploads/2015/11/02-tracks-app-opt.png))*
...
*Иллюстрация 3. Эта навигация административной панели использует строчный паттерн с вертикальным центрированием элементов навигации. ([увеличенная версия](https://www.smashingmagazine.com/wp-content/uploads/2015/11/03-admin-nav-opt.png))*
...
*Иллюстрация 4. Паттерн  навигации в шапке сайта с центрированным лого часто встречается в вебе и легко адаптируется к флексбоксу. ([увеличенная версия](https://www.smashingmagazine.com/wp-content/uploads/2015/11/04-primary-nav-opt.png))*
...
*Иллюстрация 5. Поток, представленный в разметке и его рендеринг в браузере, изменение последовательности с помощью флексбокса без изменений разметки. ([увеличенная версия](https://www.smashingmagazine.com/wp-content/uploads/2015/11/05-flexbox-order-chart-opt.png))*
...
*Иллюстрация 6. Тот же паттерн, который мы применяли для навигации, используется в футере. ([увеличенная версия](https://www.smashingmagazine.com/wp-content/uploads/2015/11/06-flex-footer-opt.png))*
...
*Иллюстрация 7. Строчные лейблы и поля ввода это еще одна область использования флексбокса. Но будьте осторожны с тем, как текст лейбла отталкивает поле ввода в зависимости от количества текста. ([увеличенная версия](https://www.smashingmagazine.com/wp-content/uploads/2015/11/07-inline-label-opt.png))*
...
*Иллюстрация 8. Решайте, как ваш контент будет расширяться. Слева `display:table` с вертикальным выравниванием по середине, справа флексбокс с выравниванием по центру. ([увеличенная версия](https://www.smashingmagazine.com/wp-content/uploads/2015/11/08-inline-input-wrap-opt.png))*
...
*Иллюстрация 9. При  использовании  полей ввода и кнопок на одной строке, баланс в дизайне создается за счет их равной высоты. ([увеличенная версия](https://www.smashingmagazine.com/wp-content/uploads/2015/11/09-inline-input-opt.png))*
...
*Иллюстрация 10. Участок страницы с выпадающим меню выделен при помощи возможностей флексбокс для быстрого позиционирования. ([увеличенная версия](https://www.smashingmagazine.com/wp-content/uploads/2015/11/10-primary-menu-opt.png))*
...
*Иллюстрация 11. Меню основного интерфейса построено с использованием флексбокса для раскладки. ([увеличенная версия](https://www.smashingmagazine.com/wp-content/uploads/2015/11/11-tracks-menu-opt.gif))*
...
*Иллюстрация 12. В паттерне медиа-объект используется флексбокс, SVG фиксированной ширины располагается слева, а все остальное содержимое флексбокса располагается рядом. ([увеличенная версия](https://www.smashingmagazine.com/wp-content/uploads/2015/11/12-media-obj-opt.png))*
...
*Календарь. ([увеличенная версия](https://www.smashingmagazine.com/wp-content/uploads/2015/11/13-calendar-opt.png))*
...
*Иллюстрация 14. Это календарь с выбором месяца, слева использовано `justify-content: space-between`, а справа `justify-content: flex-start`, слева на один элемент-обертку больше. ([увеличенная версия](https://www.smashingmagazine.com/wp-content/uploads/2015/11/14-calendar-layout-opt.png))*
...
*Иллюстрация 15. Боковая колонка влево и основной контент вправо --- это совершенный сценарий для флексбокса. Это также напоминает [технику искусственных колонок](http://alistapart.com/article/fauxcolumns). ([увеличенная версия](https://www.smashingmagazine.com/wp-content/uploads/2015/11/15-admin-layout-opt.png))*
...
*Иллюстрация 16. Приклеенный футер в правой боковой колонке. ([увеличенная версия](https://www.smashingmagazine.com/wp-content/uploads/2015/11/16-admin-sidebar-stickyfooter-opt.png))*
...
*Трубопровод. ([увеличенная версия](https://www.smashingmagazine.com/wp-content/uploads/2015/11/17-pipeline-card-opt.png))*
